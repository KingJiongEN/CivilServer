...
{
	public struct Element< SubClassKeyType, SubClassPriorityType > where SubClassPriorityType : System.IComparable
	{
	...
	public List< Element<KeyType, PriorityType> > queue = new List< Element<KeyType, PriorityType> >();
